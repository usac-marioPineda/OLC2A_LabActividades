...
public class Parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    ...
    "\002\007\001\002\000\004\002\001\001\002\000\006\002" +
    "\uffff\004\uffff\001\002" });
		...
		RESULT = start_val;
		 ...
		 write(first); 
          ...
          case 2: // L ::= L WRD 
            {
              Object RESULT =null;
		int wrdleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).left;
		int wrdright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		String wrd = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 write(wrd); write(" "); 
